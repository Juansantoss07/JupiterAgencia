...
export default function ContainerContact(){
    useEffect(() => {
      ...
      const linkInsta = () => {
        window.open('https://www.instagram.com/_jupiter_agencia');
      }
      ...
      const linkTwitter = () => {
        window.open('https://twitter.com/AgenciaJupiter');
      }

      const linkMail = () => {
        window.open(`mailto:atendimento@jupiteragencia.com`);
      }
    return (
        <>
            <section className="containerContact" id='contact'>
                ...
                <div className="containerContact_right">
                    <p>Sua empresa está pronta para o futuro? Com a nossa experiência em tecnologia e inovação, podemos ajudá-lo a implementar soluções digitais de última geração que irão transformar seu negócio e levá-lo a novos patamares de sucesso.</p>

                <div className="containerContact_btns">
                    <a href="#">
                    <button onClick={linkMail} className="btn-default btn-mail">
                    ...
                    <a href="#">
                        <button onClick={linkInsta} className="btn-default btn-insta">
                    ...
                    <a href="#">
                        <button onClick={linkWhats} className="btn-default btn-whatsapp">
                    ...
                    <a href="#">
                        <button onClick={linkTwitter} className="btn-default btn-twitter">
