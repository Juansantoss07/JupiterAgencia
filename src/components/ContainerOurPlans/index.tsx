            ...
            <section className="container-ourplans" id="plataforms">
               ...
               <div className="container-ourplans_plans">
                <div className="container-ourplans_plan">
                    ...
                    <button onClick={linkConverto} className="btn-default">Quero esse</button>
                </div>
                <div className="container-ourplans_plan">
                    <h3>PontoCom</h3>
                    ...
                    <button onClick={linkPontoCom} className="btn-default">Quero esse</button>
                </div>
                <div className="container-ourplans_plan">
                    <h3>ProductX</h3>
                    ...
                    <button onClick={linkProductX} className="btn-default">Quero esse</button>
                </div>
               </div>
            </section>
        </>
