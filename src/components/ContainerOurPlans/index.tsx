            ...
            <section className="container-ourplans" id="plataforms">
               ...
               <div className="container-ourplans_plan">
                   ...
                   <video src="/pontocom.mp4" muted loop autoPlay></video>
                    <p>ExpanseX Work é uma plataforma de portfolio que permite aos usuários criar um portfolio on-line personalizado, exibir e compartilhar facilmente seus trabalhos de forma elegante e profissional. 
                    </p>
                ...
                <div className="container-ourplans_plan">
                    <h3>ExpanseX Commerce</h3>
                    <video src="/productX.mp4" muted autoPlay loop></video>
                    <p>ExpanseX Commerce é uma plataforma de ecommerce que permite ter uma loja virtual personalizada com gerenciamento de produtos, pagamentos e rastreamento de pedidos.</p>
                ...
                <div className="container-ourplans_plan">
                    <h3>ExpanseX Schedule</h3>
                    <video src="/breve.mp4" muted autoPlay loop></video>
                    <p>ExpanseX Schedule é uma plataforma de landing pages que permite aos usuários ter páginas de destino personalizadas para campanhas de marketing on-line, com modelos, testes A/B e integração com outras ferramentas.</p>
